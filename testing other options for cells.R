...
## Sum all scans of each .mzML file and create list of MassSpectrum objects named spectra
  ...
  while (filecounter<=mzMLno)
  {
  	...
  	spectra[[filecounter]]<-importspectrum
...
peaks<-detectPeaks(importspectrum, SNR=3)
...
## Sort by columns with maxium intensity and eliminate others
...
#plot all features 
p<-ggplot(data=eugenol_featurematrix, aes(x=Concentration, y=eugenol_featurematrix$X165.086726151204)) +
...
voltage<-c("2.44","3.00","3.44","2.44","3.00","3.44","2.44","3.00","3.44","2.44","3.00","3.44","2.44","3.44","2.44","3.00","3.44")
samples <-c("a","b","c","d","e","f","g","h","i","j","k","l","m","o","p","q","r")
concentrations<-c("0.05ppm","0.5ppm","0.1ppm","1ppm","5ppm","10ppm")
